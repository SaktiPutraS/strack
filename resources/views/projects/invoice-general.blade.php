    ...
    <div class="invoice-container">
        <div class="header">
            ...
            <div class="invoice-title">
                <h1>INVOICE</h1>
                @if (!empty($stageLabel))
                    <div style="font-size:15px;font-weight:bold;color:#0D9488;letter-spacing:1px;margin-bottom:6px;">
        ...
        <div class="payment-info">
            ...
            <div class="payment-details">
                <strong>🟦 BCA : 6042125799</strong><br>
                <strong>🟧 Seabank : 901551898940</strong><br>
                <strong>🟥 CIMB : 760967985900</strong><br>
                <strong>a.n Sakti Putra S</strong><br>
                Mohon konfirmasi pembayaran ke WhatsApp: 0813-6422-2434
            </div>
        </div>
    </div>
