...
@section('content')
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
                <div>
                    <h1 class="h2 fw-bold text-purple mb-1">
                        <i class="bi bi-plus-circle me-2"></i>Tambah Prospek Baru
                    </h1>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            <form action="{{ route('prospects.store') }}" method="POST" id="prospect-form">
                @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="tel" class="form-control form-control-lg @error('whatsapp') is-invalid @enderror" id="whatsapp"
                                    name="whatsapp" value="{{ old('whatsapp') }}" placeholder="08123456789" required>
                                @error('whatsapp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <input type="url" class="form-control form-control-lg @error('social_media') is-invalid @enderror" id="social_media"
                                    name="social_media" value="{{ old('social_media') }}" placeholder="https://instagram.com/username">
                                @error('social_media')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <select name="status" id="status" class="form-select form-select-lg @error('status') is-invalid @enderror" required>
                                    <option value="BELUM_DIHUBUNGI" {{ old('status') == 'BELUM_DIHUBUNGI' ? 'selected' : '' }}>Belum Dihubungi</option>
                                    <option value="PENGECEKAN_KEAKTIFAN" {{ old('status') == 'PENGECEKAN_KEAKTIFAN' ? 'selected' : '' }}>Pengecekan
                                        Keaktifan Usaha</option>
                                    <option value="PENAWARAN" {{ old('status') == 'PENAWARAN' ? 'selected' : '' }}>Penawaran</option>
                                    <option value="FOLLOW_UP" {{ old('status') == 'FOLLOW_UP' ? 'selected' : '' }}>Follow Up Penawaran</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="5"
                                    placeholder="Catatan penting tentang prospek ini...">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror>
                            </div>
                ...
                <div class="card luxury-card border-0">
                    <div class="card-body p-4">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                            <a href="{{ route('prospects.index') }}" class="btn btn-outline-secondary btn-lg">
                                <i class="bi bi-arrow-left me-2"></i>Kembali
                            </a>
                            <div class="d-flex gap-3">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="bi bi-check-circle me-2"></i>Simpan Prospek
                                </button>
                            </div>
                        </div>
                    </div>
